 ...
 * 
 * TRISTATECRLISTING->settings->get_plugin_name();
 * 
 * HELPER COMMENT END
 */

/**
 * Class Tristatecr_Listing_Settings
 *
 * This class contains all of the plugin settings.
 * Here you can configure the whole plugin data.
 *
 * @package		TRISTATECRLISTING
 * @subpackage	Classes/Tristatecr_Listing_Settings
 * @author		CodePixelz
 * @since		1.0.0
 */
class Tristatecr_Listing_Settings{
	...
	/**
	 * Our Tristatecr_Listing_Settings constructor 
	...
	function __construct(){
		...
		$this->plugin_name = TRISTATECRLISTING_NAME;
	}
	...
	public function get_plugin_name(){
		return apply_filters( 'TRISTATECRLISTING/settings/get_plugin_name', $this->plugin_name );
	}
}
